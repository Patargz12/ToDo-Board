...
const buttonVariants = ({ variant }: { variant?: string } = {}) =>
  variant === 'ghost'
    ? 'inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-white/8 hover:text-slate-200 disabled:pointer-events-none disabled:opacity-50'
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "",
        weekday: cn(
          "pb-1 text-center text-[0.8rem] font-normal text-muted-foreground select-none",
        ),
        ...
        day: cn(
          "group/day relative p-0 text-center align-middle select-none",
...
function CalendarDayButton({
  ...
  return (
    <button
      ...
      className={cn(
        "mx-auto flex items-center justify-center rounded-md text-sm font-normal transition-colors",
        "size-8 p-0 leading-none select-none",
        ...
        "data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-primary/20 data-[range-middle=true]:text-slate-200",
