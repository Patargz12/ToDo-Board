      ...
      <div className="bg-slate-900 border border-white/10 shadow-2xl rounded-t-2xl sm:rounded-2xl w-full sm:max-w-2xl h-[85vh] sm:h-auto sm:max-h-[80vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-white/[0.07] shrink-0">
            ...
            {showDeleteConfirm ? (
              <div className="flex items-center gap-2.5">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-red-500/20 hover:bg-red-500/30 text-red-300 border border-red-500/30 text-sm font-medium rounded-lg transition-colors"
                >
                  Delete
                </button>
                <button
                  onClick={() => setShowDeleteConfirm(false)}
                  className="px-3 py-1.5 bg-white/8 hover:bg-white/12 text-slate-400 border border-white/10 text-sm font-medium rounded-lg transition-colors"
                >
                  Cancel
                </button>
              </div>
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-red-300 bg-red-500/15 hover:bg-red-500/25 border border-red-500/25 rounded-xl transition-colors"
              >
                Delete
              </button>
            )}
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleClose}
              className="px-4 py-2 text-sm font-medium text-slate-400 bg-white/7 hover:bg-white/12 border border-white/10 rounded-xl transition-colors"
            >
            ...
            <button
              ...
              className="px-5 py-2 text-sm font-semibold text-white bg-linear-to-br from-indigo-500 to-violet-500 shadow-[0_4px_14px_rgba(99,102,241,0.4)] hover:shadow-[0_6px_20px_rgba(99,102,241,0.55)] disabled:opacity-50 disabled:cursor-not-allowed rounded-xl transition-all flex items-center gap-2"
            >
              {saving && (
